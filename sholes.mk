...
$(call inherit-product-if-exists, vendor/BlackICE/configs/common.mk)
$(call inherit-product-if-exists, vendor/moto/sholes/sholes-vendor.mk)
...
PRODUCT_COPY_FILES += $(shell \
    find device/moto/sholes/kernel/lib/modules -name '*.ko' \
    | sed -r 's/^\/?(.*\/)([^/ ]+)$$/\1\2:system\/lib\/modules\/\2/' \
    | tr '\n' ' ')

ifeq ($(TARGET_PREBUILT_KERNEL),)
LOCAL_KERNEL := device/moto/sholes/kernel/kernel
else
OCAL_KERNEL := $(TARGET_PREBUILT_KERNEL)
endif
...
# Get some sounds
$(call inherit-product-if-exists, frameworks/base/data/sounds/MinimalAudio.mk)
